...
public class ScoreServiceJDBC implements ScoreService {
    ...
    private ScoreServiceJDBC() throws ScoreException {
        try {
    ...
    /**
     * Singleton of Score service.
     * @return service singleton
     * @throws ScoreException when creating fails
     */
    public static ScoreServiceJDBC getInstance() throws ScoreException {
        if (ScoreServiceJDBC.instance == null){
            ScoreServiceJDBC.instance = new ScoreServiceJDBC();
        }
        return ScoreServiceJDBC.instance;
    }
