...
public class RatingServiceJDBC implements RatingService{
    ...
    private RatingServiceJDBC() throws RatingException {
        try {
    ...
    /**
     * Singleton of Rating service.
     * @return instance of rating service
     * @throws RatingException when creating of instance fails
     */
    public static RatingServiceJDBC getInstance() throws RatingException {
        if (RatingServiceJDBC.instance == null){
            RatingServiceJDBC.instance = new RatingServiceJDBC();
        }
        return RatingServiceJDBC.instance;
    }
